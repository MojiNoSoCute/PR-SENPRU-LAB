...
class Program extends Model
{
    ...
    {
        return $this->hasMany(CareerOpportunity::class, 'program_id', 'program_id');
    }
    
    public function laboratories()
    {
        return $this->hasMany(Laboratory::class, 'program_id', 'program_id');
    }
    
    public function studentWorks()
    {
        return $this->hasMany(StudentWork::class, 'program_id', 'program_id');
    }
    ...
    {
        return $this->hasMany(Video::class, 'program_id', 'program_id');
    }
